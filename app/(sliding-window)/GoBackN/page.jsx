...
const GBN = () => {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      setState((prev) => {
        ...
        setStats((s) => {
          const sent = newState.packets.filter(p => p.status === "sent").length;
          ...
          return { sent, acked, lost, lostPackets };
        });
  ...
  const handleReset = () => {
    ...
    setPaused(false);
    setStepCount(0);
    setStats({ sent: 0, acked: 0, lost: 0, lostPackets: [] });
    setState({
      packets: createPackets(totalPackets),
      base: 0,
      nextSeq: 0,
    ...
    <div style={{
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24, marginBottom: 30 }}>
          ...
          {/* Left: Visualization */}
          <div>
            <h3 style={{ marginTop: 0, fontSize: 20, fontWeight: 700, marginBottom: 16 }}>📦 Packet Window</h3>
            <SenderWindow 
            ...
            <div style={{
              ...
              <p style={{ margin: "0 0 8px 0" }}><strong>Base (Oldest unacked):</strong> {state.base}</p>
        ...
        <div style={{
          ...
          <ul style={{ margin: 0, paddingLeft: 20, fontSize: 15, lineHeight: 1.8 }}>
            <li><strong>Window Size:</strong> Sends multiple packets before waiting</li>
            <li><strong>Retransmission:</strong> On packet loss, retransmits ALL packets from that point</li>
            <li><strong>Cumulative ACK:</strong> One ACK acknowledges all packets up to sequence number</li>
            <li><strong>Efficiency:</strong> Moderate - retransmits unnecessary packets</li>
            <li><strong>Use Case:</strong> Older networks, moderate-speed links</li>
          </ul>
        </div>
      </div>
    </div>
