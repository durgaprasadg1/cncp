  ...
  return (
    <div
      style={{
        ...
        height: 70,
        background: color,
        border: inWindow ? "3px solid white" : "2px solid rgba(255,255,255,0.5)",
        borderRadius: 8,
        display: "flex",
        alignItems: "center",
        ...
        animation: packet.status === "sent" ? "packet-send 1s ease-in-out infinite" : 
                   packet.status === "retrying" ? "packet-retry 0.5s ease-in-out infinite" : 
                   packet.status === "lost" ? "packet-shake 0.3s ease-in-out infinite" : "none"
      }}
